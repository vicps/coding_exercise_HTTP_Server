...
*note: the server will start automatically
...
5- Install the dependencies using `pip install -r requirements.txt` . This .txt file installs Flask, validators, requests and selenium
...
5- On the correct folder, execute the .py file: `python revelo_challenge.py`
...
7- In the web page created for this HTTP Server, you can short any URL you want. Just put the inputs in the correct fields.
...
NOTE: Test cases in `test cases - revelo challenge` worksheet
